    ...
    choices: [
        {
            id: "strategist",
            team: "strategist",
            text: "Мы — тестировщики. Мы привыкли работать с тёмными коробками",
            points: {
                ownTeam: 15,
                otherTeam: 15
            },
    ...
    
        {
            id: "joker",
            team: "joker",
            text: "У нас есть умная лампочка! Она осветит нам путь!",
            points: {
                ownTeam: 50,
                otherTeam: 50
            },
    ...
    
        {
            id: "critic",
            team: "critic",
            text: "Нет, это слишком опасно. Мы не готовы",
            points: {
                ownTeam: 15,
                otherTeam: 15
            },
